								...
								<section id="penyajian">
									...
									<p>
										...
										<div className="container">
											Carilah daerah definisi dan daerah nilai dari fungsi <InlineMath math="g(x)=\sqrt{9-x^2}" />
											<br />
											<p className='mt-2'>
								...
								<section id="kesamaan">
									...
									<p>
										...
										<div className="container">
											...
											Contoh: <br />
											Fungsi <InlineMath math="f(x) = \cos^2 x" /> dan <InlineMath math="g(x)=1-\sin^2x" /> adalah sama, karena <InlineMath math="D_f = D_g =R" /> dan <InlineMath math="f(x) = g(x)" />, untuk setiap{' '}
											<InlineMath math="x \in R" />
										</div>
									</p>
								</section>
							</div>
